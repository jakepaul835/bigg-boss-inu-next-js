...
contract Presale is IPresale, AccessControl, Pausable {
  ...
  constructor(
    ...
    COIN_PRICE_FEED = AggregatorV3Interface(0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419);
    ...
    stages.push(StageData(8372,7167006225,7167006225));   // 0.00008372
    stages.push(StageData(11416,7445462536,7445462536));  // 0.00011416
    stages.push(StageData(13953,6450208847,6450208847));  // 0.00013953
    stages.push(StageData(15697,5733461639,5733461639));  // 0.00015697
    stages.push(StageData(17940,4738140066,4738140066));  // 0.0001794
    stages.push(StageData(20930,5972415599,5972415599));  // 0.0002093
    stages.push(StageData(25116,4578806171,4578806171));  // 0.00025116
    stages.push(StageData(41860,2150037365,2150037365));  // 0.0004186
    stages.push(StageData(78487,764461552,764461552));  // 0.00078487
    stages.push(StageData(0, 0, 0)); // End
